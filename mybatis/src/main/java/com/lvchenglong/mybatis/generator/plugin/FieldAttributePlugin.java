package com.lvchenglong.mybatis.generator.plugin;
...
//        root.addImportedType(model + "." + queryVoName);
        ...
        root.addImportedType("com.lvchenglong.mybatis.help.DbField");
        root.addImportedType("com.lvchenglong.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.lvchenglong.mybatis.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.lvchenglong.mybatis.help.FieldResult"));
